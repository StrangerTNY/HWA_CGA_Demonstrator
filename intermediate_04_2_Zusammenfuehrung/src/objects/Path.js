...
export default class Path extends THREE.Group {
  ...
  constructor() {
    ...
    const pathGeometry = new THREE.PlaneGeometry(100,500);
    ...
    path.rotation.set(THREE.MathUtils.degToRad(-90),0,THREE.MathUtils.degToRad(-90));
